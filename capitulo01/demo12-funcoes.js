function nomeDaFuncao(parametro1){//bloco do codigo
}
...
// Funções tambem podem retornar valores
function soma(valor1, valor2){
...
// console.log(`Funcionario': ${descontoFuncionario1}
...
funcionario1.salarioLiquido = calcularDesconto(funcionario1.salarioBruto,
    funcionario1.desconto
)

funcionario2.salarioLiquido = calcularDesconto(funcionario2.salarioBruto,
