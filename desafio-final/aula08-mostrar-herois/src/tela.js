...
//por ussi, nao vamos colocar o util ao constutor no static
const util = Util
...
class Tela {
    ...
    static gerarStringHTMLPelaImagem(itens){
        //para cada item da lista, vai executar a funcao obterCodigo HTML
    ...
    static exibirHerois(nomeDoHeroi, img) {
        ...
        //para cada elemtno encontrado na tela, vamos alterar a imagem
        //para a imagem inicial dele
        //com o forEach, para cada item, dentro dos () 
        //setamos o valor de imagem
    ...
    static iniciarContador() {
        ...
        //vamos substituir o texto Começando $$contador segudos
        ...
        //essa fução vai substituar o $$contator pelo 'contarAte' diminuindo o valor
        //retornamos o idDoIntervalo para 
